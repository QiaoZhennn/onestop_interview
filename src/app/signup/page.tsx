      ...
      <div className="min-h-screen bg-coder-bg flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="bg-coder-surface border border-coder-border rounded-lg p-6 text-center">
            <CheckCircle className="text-coder-success mx-auto mb-4" size={48} />
            ...
            <p className="text-sm text-coder-text-dim mb-4">
              ...
              <a href="/login" className="text-coder-brown hover:text-coder-brown-light">sign in</a>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-coder-surface border border-coder-border rounded-lg overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-2 bg-coder-card border-b border-coder-border">
            ...
            <span className="text-xs text-coder-text-dim ml-2">Sign Up</span>
          </div>

          <form onSubmit={handleSignup} className="p-6 space-y-4">
            <div>
              <label className="text-xs text-coder-text-dim block mb-1">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="text-xs text-coder-text-dim block mb-1">Password</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="text-xs text-coder-text-dim block mb-1">Confirm Password</label>
              <input
                type="password"
